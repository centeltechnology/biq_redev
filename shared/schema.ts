...
import { pgTable, text, varchar, integer, decimal, date, timestamp, jsonb, uniqueIndex, boolean, index } from "drizzle-orm/pg-core";
...
export const bakers = pgTable("bakers", {
  ...
  milestonePricingLiveSent: boolean("milestone_pricing_live_sent").default(false).notNull(),
  milestoneFirstLeadSent: boolean("milestone_first_lead_sent").default(false).notNull(),
  milestoneFirstQuoteSent: boolean("milestone_first_quote_sent").default(false).notNull(),
  milestoneFirstPaymentSent: boolean("milestone_first_payment_sent").default(false).notNull(),
