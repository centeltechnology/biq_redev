...
- **Dashboard Onboarding Checklist**: "Let's Get You Paid" checklist guiding users through Stripe connection, sending first quote (including a test quote option), and sharing their calculator link. Features completion tracking, revenue metric placeholders until activation, and exclusion for admin users.
